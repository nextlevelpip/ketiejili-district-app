...
export default function DashboardLayout({ children }) {
  ...
  const authorizedNavItems = navItems.filter(item => {
    ...
    if (currentUser.tierLevel === 3) {
      // Group Leaders ONLY see Operational Tools (Welfare is blocked here!)
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden text-gray-900 font-sans">
      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden relative">
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar relative flex flex-col bg-gray-50">
          ...
          {/* BRANDING FOOTER */}
          <footer className="w-full bg-slate-900 text-center py-5 mt-auto border-t border-slate-800">
            <p className="text-xs font-bold text-slate-400 tracking-wider">
              2026 &copy; All rights reserved | Developed by <span className="text-blue-400 font-black">Next Level Pip Systems</span>
            </p>
            <a href="mailto:nextlevelpip@gmail.com" className="text-[10px] font-bold text-slate-500 hover:text-blue-400 mt-2 flex items-center justify-center gap-1.5 transition-colors">
        ...
        <a 
          ...
          className="fixed bottom-6 right-6 z-[100] bg-[#25D366] hover:bg-[#1ebd57] text-white p-3 sm:px-5 sm:py-3 rounded-full font-extrabold shadow-2xl flex items-center gap-2 transition-all hover:scale-105"
        >
          ...
          <span className="hidden sm:inline">Hello! needs help?</span>
        </a>
