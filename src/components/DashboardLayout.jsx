    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden text-gray-900 font-sans">
      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden relative">
        ...
        <a 
          ...
          className="fixed bottom-6 right-6 z-[100] bg-[#25D366] hover:bg-[#1ebd57] text-white px-5 py-3 rounded-full font-extrabold shadow-2xl flex items-center gap-2 transition-all hover:scale-105"
        >
