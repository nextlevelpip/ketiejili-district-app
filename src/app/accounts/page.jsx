...
export default function UserAccounts() {
  ...
  const confirmSendSetupSMS = async () => {
    ...
    const message = `Praise the Lord ${String(user.name).split(' ')[0]}! You have been granted access to the AltarConnect Command Centre. Your Setup Code is: ${user.setupCode}. Go to https://bit.ly/katiejili-district to secure your account.`;
